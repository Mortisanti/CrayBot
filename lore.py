...
We traced the communiqué back to Oslo, where the subject was staying in a locally owned hostel. The subject was an American freelance operative specializing in linguistics. We were unable to determine the party who originally contracted the services of the subject. However, when we entered the subject's room, he was in the process of composing a summary report, and our agents were able to successfully contain the transmission and terminate the subject. The last entry of his documentation is cited below. (A full report will be delivered by hand in London.) 
